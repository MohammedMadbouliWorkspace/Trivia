...
db.init_app(create_app("flaskr/testing.py"))
...
def fill_database():
    ...
    questions = [
        (
            "Whose autobiography is entitled 'I Know Why the Caged Bird"
            " Sings'?",
            "Maya Angelou",
            2,
            4,
        ...
        (
            "What actor did author Anne Rice first denounce, then praise in"
            " the role of her beloved Lestat?",
            "Tom Cruise",
            4,
            5,
        ),
        ...
        (
            "Which is the only team to play in every soccer World Cup"
            " tournament?",
            "Brazil",
            3,
            6,
        ...
        (
            "Which Dutch graphic artist–initials M C was a creator of optical"
            " illusions?",
            "Escher",
            1,
            2,
    ...
    for q, answer, difficulty, category_id in questions:
        question = Question(
            question=q,
            answer=answer,
